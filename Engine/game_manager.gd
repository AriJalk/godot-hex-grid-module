...
var _placement_tile : PlacementTile
var _last_hex : Hex
var _delta = 0


var _command_stack : CommandStack
...
func _ready() -> void:
	...
	var tile_scene = preload("res://Nodes/hex_tile.tscn")
	_node_pool.register_prefab(game_resources[HexTile], tile_scene.instantiate(), 300)
	var collision_scene = preload("res://Nodes/hex_slot.tscn")
	_node_pool.register_prefab(game_resources[HexSlot], collision_scene.instantiate(), 300)
	...
	var tile_object = _node_pool.retrieve_prefab(game_resources[HexTile])
	_hex_grid.remove_child(_placement_tile)
	_placement_tile.add_child(tile_object)
